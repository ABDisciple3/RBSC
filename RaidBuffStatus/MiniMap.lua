...
function RBSMinimapButton:OnEnter()
	if not self.dragging then
		...
		GameTooltip:SetText(RaidBuffStatus.L["Click to toggle the RBS dashboard"])
		GameTooltip:AddLine(RaidBuffStatus.L["Right-click to open the addons options menu"])
		GameTooltip:Show()
	end
end
